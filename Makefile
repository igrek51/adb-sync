...
LINK          = g++
LFLAGS        = -lboost_system -lboost_thread -g -rdynamic -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		src/synchronizer/DiffSync.h src/main.cpp \
		src/logger/Logger.cpp \
		src/dispatcher/EventDispatcher.cpp \
		src/dispatcher/IEventObserver.cpp \
		src/dispatcher/Event.cpp \
