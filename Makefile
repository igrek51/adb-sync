...
LINK          = g++
LFLAGS        = -Bstatic -lboost_system -lboost_thread -Bdynamic -g -rdynamic -Wl,-O1 -Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now
...
build/.moc/moc_predefs.h: /usr/lib/qt/mkspecs/features/data/dummy.cpp
	g++ -pipe -std=c++11 -O2 -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector-strong -fno-plt -Wall -W -dM -E -o build/.moc/moc_predefs.h /usr/lib/qt/mkspecs/features/data/dummy.cpp
