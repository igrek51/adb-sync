#############################################################################
# Makefile for building: Synchronizator-Cross
# Generated by qmake (3.1) (Qt 5.8.0)
# Project:  Synchronizator-Cross.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile Synchronizator-Cross.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Synchronizator-Cross1.0.0
DISTDIR = /mnt/data/Igrek/c++/adb-sync/.tmp/Synchronizator-Cross1.0.0
LINK          = g++
...
SOURCES       = src/dir.cpp \
		...
		src/mainwindow.cpp \
		src/program.cpp \
		src/synchro.cpp moc_mainwindow.cpp
OBJECTS       = dir.o \
		history.o \
		lista.o \
		listbox.o \
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		Synchronizator-Cross.pro src/dir.h \
		src/history.h \
		src/lista.h \
		src/mainwindow.h \
		...
		src/program.cpp \
		src/synchro.cpp
QMAKE_TARGET  = Synchronizator-Cross
DESTDIR       = 
TARGET        = Synchronizator-Cross
...
Makefile: Synchronizator-Cross.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
...
moc_mainwindow.cpp: src/synchro.h \
		src/lista.h \
		src/dir.h \
		src/history.h \
		src/mainwindow.h \
		moc_predefs.h \
		/usr/bin/moc
	/usr/bin/moc $(DEFINES) --include ./moc_predefs.h -I/usr/lib/qt/mkspecs/linux-g++ -I/mnt/data/Igrek/c++/adb-sync -I/mnt/data/Igrek/c++/adb-sync -I/usr/include/qt -I/usr/include/qt/QtWidgets -I/usr/include/qt/QtGui -I/usr/include/qt/QtCore -I/usr/include/c++/6.3.1 -I/usr/include/c++/6.3.1/x86_64-pc-linux-gnu -I/usr/include/c++/6.3.1/backward -I/usr/lib/gcc/x86_64-pc-linux-gnu/6.3.1/include -I/usr/local/include -I/usr/lib/gcc/x86_64-pc-linux-gnu/6.3.1/include-fixed -I/usr/include src/mainwindow.h -o moc_mainwindow.cpp
...
lista.o: src/lista.cpp src/lista.h \
		...
		src/dir.h \
		src/history.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o lista.o src/lista.cpp

listbox.o: src/listbox.cpp src/mainwindow.h \
		src/synchro.h \
		src/lista.h \
		src/dir.h \
		src/history.h \
		ui_mainwindow.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o listbox.o src/listbox.cpp
...
program.o: src/program.cpp src/mainwindow.h \
		src/synchro.h \
		src/lista.h \
		src/dir.h \
		src/history.h \
...
synchro.o: src/synchro.cpp src/synchro.h \
		src/lista.h \
		src/dir.h \
		src/mainwindow.h \
		src/history.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o synchro.o src/synchro.cpp
